...
public class InsulinWeeklyReport extends TabActivity implements IJournalListItems, TabHost.TabContentFactory {
	...
	public InsulinWeeklyReport(){
		  NAME = "InsulinWeeklyReport";
		  DESC = "InsulinWeeklyReport for usage";
	} 
