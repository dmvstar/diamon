...
public class DBHelper extends SQLiteOpenHelper {
	...
	private SQLiteDatabase diamondb;
	...
	private static String getDBName(Context context) {
		String ret = DB_NAME;
		try {
			String dbSDPath = Environment.getExternalStorageDirectory()
					.getPath()
					+ "/Android/data/"
					+ context.getPackageName()
					+ "/databases/" + DB_NAME;
			DB_FULL_PATH = dbSDPath; 
		} catch (Exception e) {
		}
		return ret;
	}
	...
	public void clearAll() {
		diamondb.delete(TABLE_NAME, null, null);
	}
	...
	public Cursor cursorSelectAll() {
		Cursor cursor = this.diamondb.query(TABLE_NAME, // Table Name
